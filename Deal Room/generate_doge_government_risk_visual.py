#!/usr/bin/env python3
"""
Generate risk score breakdown bar chart for DOGE Government Intelligence Audit
Shows critical risk surfaces (85%+)
"""
...
# Risk scores from DOGE Government Intelligence Audit (Critical only: 85%+)
categories = [
...
risk_scores = [91, 87, 85]  # Percentages (Critical risk surfaces only)
...
# Add title
ax.set_title('DOGE Government Intelligence: Critical Risk Surfaces', 
...
output_path = 'Deal Room/Assets/doge_government_risk_score_breakdown.png'
